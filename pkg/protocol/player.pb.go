...
const file_player_proto_rawDesc = "" +
	...
	"\x06player\x18\x01 \x01(\v2\x0e.player.PlayerR\x06player2V\n" +
	"\x0ePlayerServices\x12D\n" +
...
var file_player_proto_depIdxs = []int32{
	...
	1, // 1: player.PlayerServices.GetPlayerInfo:input_type -> player.GetPlayerInfoReq
	2, // 2: player.PlayerServices.GetPlayerInfo:output_type -> player.GetPlayerInfoResp
