...
// func createStartClawGameRequest(playerID, machineID int64) []byte {
...
// func createAddTouchedItemRecordRequest(gameID, itemID int64, catched bool) []byte {
// 	builder := flatbuffers.NewBuilder(1024)
...
// func createSpawnItemRequest(machineID int64) []byte {
// 	builder := flatbuffers.NewBuilder(1024)
