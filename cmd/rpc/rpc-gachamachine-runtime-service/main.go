...
import (
	...
	c "github.com/1nterdigital/game/internal/service/rpc/gachaMachine_runtime"
...
func main() {
	...
	runtimeService := c.NewGachaMachineWebsocketService(gachaMachineRepo, redisClient, cfg.StreamConsumer.StreamKey)
