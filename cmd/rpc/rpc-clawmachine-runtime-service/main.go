...
import (
	...
	c "github.com/1nterdigital/game/internal/service/rpc/clawMachine_runtime"
...
func main() {
	...
	if cfg.Discovery.Enabled {
		...
		if err != nil {
			...
			err = serviceRegistry.RegisterService("clawmachine-runtime-service", cfg.Service.Host, cfg.Service.Port)
			if err != nil {
